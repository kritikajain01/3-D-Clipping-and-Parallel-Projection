...
class cl_world:
    ...
    def create_graphic_objects(self, canvas):
        ...
        if True:
            for face in self.faces:
                ...
                k = 0
                if Jain_03_04.clip_line_parallel(vertexes[face[0] - 1], vertexes[face[1] - 1]) != [] :
                    k=k+1
                if Jain_03_04.clip_line_parallel(vertexes[face[1] - 1],vertexes[face[2] - 1]) != [] :
                    k = k+1
                if Jain_03_04.clip_line_parallel(vertexes[face[2] - 1],vertexes[face[0] - 1]) != []:
                    k = k+1
                if k> 1:
                    if Jain_03_04.clip_line_parallel(vertexes[face[0] - 1], vertexes[face[1] - 1]) != []:
                        point1, point2 = Jain_03_04.clip_line_parallel(vertexes[face[0] - 1], vertexes[face[1] - 1])
                    if Jain_03_04.clip_line_parallel(vertexes[face[1] - 1],vertexes[face[2] - 1]) != []:
                        point2, point3 = Jain_03_04.clip_line_parallel(vertexes[face[1] - 1], vertexes[face[2] - 1])
                    if Jain_03_04.clip_line_parallel(vertexes[face[2] - 1],
                                                                      vertexes[face[0] - 1]) != []:
                        point3, point1 = Jain_03_04.clip_line_parallel(vertexes[face[2] - 1], vertexes[face[0] - 1])
                    # print(point1)
    ...
    def redisplay(self, canvas, ):
            ...
            for face in self.faces:
                ...
                if k > 1:
                    if Jain_03_04.clip_line_parallel(vertexes[face[0] - 1], vertexes[face[1] - 1]) != []:
                        point1, point2 = Jain_03_04.clip_line_parallel(vertexes[face[0] - 1],
                                                                               vertexes[face[1] - 1])
                    if Jain_03_04.clip_line_parallel(vertexes[face[1] - 1], vertexes[face[2] - 1]) != []:
                        point2, point3 = Jain_03_04.clip_line_parallel(vertexes[face[1] - 1],
                                                                               vertexes[face[2] - 1])
                    if Jain_03_04.clip_line_parallel(vertexes[face[2] - 1],
                                                             vertexes[face[0] - 1]) != []:
                        point3, point1 = Jain_03_04.clip_line_parallel(vertexes[face[2] - 1],
                                                                               vertexes[face[0] - 1])
